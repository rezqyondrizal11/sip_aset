<form id="createForm" action="{{ route('asettetap.update') }}" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="luas" name="luas" value="{{ $data->luas }}">
        @error('luas')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="tahun_pengadaan" name="tahun_pengadaan" min="1900"
            max="{{ date('Y') }}" step="1" value="{{ $data->tahun_pengadaan }}">
    ...
    <div class="form-group">
        ...
        <textarea name="alamat" id="Alamat" class="form-control" cols="30" rows="4">{{ $data->alamat }}</textarea>
