                ...
                <tbody>
                    ...
                    @foreach ($cat->asettetap as $keyy => $aset)
                        ...
                        <tr>
                            ...
                            <td>{{ $aset->kode }}</td>
                            <td>{{ $aset->register }}</td>
                            <td>{{ $aset->KibDJalanirigasi->konstruksi }}</td>
                            <td>{{ $aset->KibDJalanirigasi->panjang }}</td>
                            <td>{{ $aset->KibDJalanirigasi->lebar }}</td>
                            <td>{{ $aset->KibDJalanirigasi->luas }}</td>
                            <td>{{ $aset->KibDJalanirigasi->alamat }}</td>
                            <td>{{ $aset->KibDJalanirigasi->kondisi }}</td>

                            <td>{{ $aset->KibDJalanirigasi->dok_tgl }}</td>
                            <td>{{ $aset->KibDJalanirigasi->dok_no }}</td>
                            <td>{{ $aset->KibDJalanirigasi->status_tanah }}</td>
                            <td>{{ $aset->KibDJalanirigasi->no_kode_tanah }}</td>
