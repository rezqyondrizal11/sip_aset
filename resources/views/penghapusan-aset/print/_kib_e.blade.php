                ...
                <tbody>
                    ...
                    @foreach ($cat->asettetap as $keyy => $aset)
                        ...
                        <tr>
                            ...
                            <td>{{ $aset->kode }}</td>
                            <td>{{ $aset->register }}</td>
                            <td>{{ $aset->KibEAsetlainnya->judul }}</td>
                            <td>{{ $aset->KibEAsetlainnya->pencipta }}</td>
                            <td>{{ $aset->KibEAsetlainnya->spesifikasi }}</td>
                            <td>{{ $aset->KibEAsetlainnya->asal_daerah }}</td>
                            <td>{{ $aset->KibEAsetlainnya->bahan }}</td>
                            <td>{{ $aset->KibEAsetlainnya->jenis }}</td>
